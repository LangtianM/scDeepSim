...
![Controlled Batch Integration Benchmark](../experiments/outputs/batch_integration_full_exact/results/batch_integration_response_curves.png)
...
Why stress test with our simulator?

- Showing the difference of the rate of decay
  
  - scanorama is overcorrecting

- Either very weak or strong batch effect would make it harder to oreserve cell type information.
